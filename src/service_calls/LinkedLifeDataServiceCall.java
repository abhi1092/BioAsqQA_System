...
public class LinkedLifeDataServiceCall
{
    private static final String server = "http://bioasq.org:8000/triples";
    URL url;
    static StringBuilder sessionURL;
    public LinkedLifeDataServiceCall() throws UnsupportedEncodingException, IOException{
    	url = new URL(server);
