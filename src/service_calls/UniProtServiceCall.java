...
public class UniProtServiceCall {
	private static final String server = "http://bioasq.org:8000/uniprot";
	static URL url;
	static StringBuilder sessionURL;
	public UniProtServiceCall()throws IOException{
		url = new URL(server);
    ...
    public JSONArray QueryUniProt(String keywords) throws IOException
    {
