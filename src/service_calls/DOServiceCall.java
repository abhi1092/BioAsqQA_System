...
public class DOServiceCall {
	private static final String server = "http://bioasq.org:8000/do";
	static URL url;
	static StringBuilder sessionURL;
	public DOServiceCall()throws IOException{
		url = new URL(server);
    ...
    public JSONArray QueryDO(String keywords) throws IOException
    {
