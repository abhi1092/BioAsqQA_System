...
public class GOServiceCall {
	private static final String server = "http://bioasq.org:8000/go";
	static URL url;
	static StringBuilder sessionURL;
	public GOServiceCall()throws IOException{
		url = new URL(server);
    ...
    public JSONArray QueryGO(String keywords) throws IOException
    {
