...
public class MeSHServiceCall {
	private static final String server = "http://bioasq.org:8000/mesh";
	static URL url;
	static StringBuilder sessionURL;
	public MeSHServiceCall()throws IOException{
		url = new URL(server);
    ...
    public JSONArray QueryMeSH(String keywords) throws IOException
    {
